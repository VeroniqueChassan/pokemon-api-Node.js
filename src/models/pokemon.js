    ...
    "Pokemon",
    {
      ...
      hp: {
        ...
        validate: {
          ...
          min: {
            args: [0],
            msg: "Les points de vie doivent être superieurs ou égales à 0",
          },
          max: {
            args: [999],
      ...
      cp: {
        ...
        validate: {
          ...
          min: {
            args: [0],
            msg: "Les points de dégâts doivent être superieurs ou égales à 0",
          },
          max: {
            args: [99],
            msg: "Les points de vie doivent être inferieurs ou égales à 99",
          },
          notNull: { msg: "es points de dégâts sont une propriété requise" },
        },
      },
      picture: {
        type: DataTypes.STRING,
